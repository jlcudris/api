...
class ResponseHttp {
    ...
    final public static function status400(string $res ='Solicitud enviada incompleta o formato incorrecto')
    {
    ...
    final public static function status404(string $res ='Ruta incorrecta verificar documentación')
    {
    ...
    final public static function status500(string $res ='Error intreno del servidor')
    {
